...
% motivation of problem: ABC/pseudo-marginal, diffusions.
% lit review.
...
\end{equation*}
The inner product of $\ket{u} = u_0\ket{0} + u_1\ket{1}$ with $\ket{v} = v_0\ket{0} + v_1\ket{1}$ is therefore computed as %use alpha beta delta gamma instead?
\begin{align*}
