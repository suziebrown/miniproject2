...
\end{itemize}
For example, the operator $X$ is self-adjoint and unitary. Trivially, unitary transformations are always reversible (i.e.\ the inverse operator exists).
...
Density operators have a neat geometrical representation as points in a unit sphere (Figure [REF]). This is called the \emph{Bloch sphere}, and can be thought of as the state space of a quantum bit (qubit).
